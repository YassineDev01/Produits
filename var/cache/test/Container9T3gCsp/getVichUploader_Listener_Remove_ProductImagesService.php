 ...
 */
class getVichUploader_Listener_Remove_ProductImagesService extends App_KernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance = new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('product_images', ($container->privates['vich_uploader.adapter.orm'] ??= new \Vich\UploaderBundle\Adapter\ORM\DoctrineORMAdapter()), ($container->privates['vich_uploader.metadata_reader'] ?? self::getVichUploader_MetadataReaderService($container)), $a);

        if (isset($container->privates['vich_uploader.listener.remove.product_images'])) {
            return $container->privates['vich_uploader.listener.remove.product_images'];
        }

        return $container->privates['vich_uploader.listener.remove.product_images'] = $instance;
    }
}
