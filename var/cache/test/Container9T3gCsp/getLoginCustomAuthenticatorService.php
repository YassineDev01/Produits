 ...
 */
class getLoginCustomAuthenticatorService extends App_KernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['App\\Security\\LoginCustomAuthenticator'])) {
            return $container->privates['App\\Security\\LoginCustomAuthenticator'];
        }

        $instance = new \App\Security\LoginCustomAuthenticator($a);

        if (isset($container->privates['App\\Security\\LoginCustomAuthenticator'])) {
            return $container->privates['App\\Security\\LoginCustomAuthenticator'];
        }

        return $container->privates['App\\Security\\LoginCustomAuthenticator'] = $instance;
    }
}
